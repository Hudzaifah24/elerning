@php
    $active = "flex items-center p-2 text-gray-900 bg-gray-100 dark:bg-gray-700 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group";
    $inActive = "flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group";
@endphp
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    class="{{ Route::is('admin.dashboard') ? $active : $inActive }}">
            ...
            <li>
                <a href="{{ route('admin.user.index') }}"
                    class="{{ Route::is('admin.user.*') ? $active : $inActive }}">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <form id="logout"
                    class="w-full text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    action="">
                    <button class="w-full p-2 flex" type="submit" onclick="confirm('Yakin ingin keluar?')">
